...
const translations = {
  en: {
    ...
    whyChooseSubtitle: 'We deliver excellence through innovation, quality, and customer satisfaction',
    readyToStart: 'Ready to Get Started?',
    readySubtitle: 'Contact us today for customized solutions that meet your specific industrial requirements',
    getInTouch: 'Get in Touch',
    ourProducts: 'Our Products',
    ourProductsSubtitle: 'Comprehensive range of industrial hose solutions and fittings',
    
    // Product Features
    qualityAssurance: 'Quality Assurance',
    qualityDesc: 'ISO certified manufacturing processes ensuring the highest quality standards',
    ...
    flexibleHoseDesc: 'High-quality flexible hoses for various industrial applications',
    bellowSolutions: 'Bellow Solutions',
    bellowDesc: 'Precision-engineered bellow systems for specialized requirements',
    endFittings: 'End Fittings',
    endFittingsDesc: 'Comprehensive range of end fittings including flanges and couplings',
    flanges: 'Flanges',
    ...
    flexibleHosesSubtitle: 'High-quality flexible hoses for diverse industrial applications',
    metalFlexibleHoses: 'Metal Flexible Hoses',
    metalHoseDesc: 'High-performance metal hoses designed for extreme temperature and pressure conditions',
    foodGradeHoses: 'Food Grade Hoses',
    foodHoseDesc: 'FDA approved hoses specifically designed for food and beverage industry applications',
    compositeHoses: 'Composite Tanker Hoses',
    compositeDesc: 'Heavy-duty composite hoses for marine and industrial tanker applications',
    ...
    customHoseDesc: 'Contact our experts for customized hose solutions tailored to your specific requirements',
    
    // Bellows Page
    bellowSolutionsTitle: 'Bellow Solutions',
    bellowSolutionsSubtitle: 'Precision-engineered expansion joints and bellows for industrial applications',
    stainlessBellows: 'Stainless Steel Expansion Bellows',
    stainlessBellowDesc: 'High-quality stainless steel bellows for thermal expansion and vibration absorption',
    rubberBellows: 'Rubber Expansion Bellows',
    rubberBellowDesc: 'Flexible rubber bellows designed for vibration isolation and thermal movement',
    ptfeBellows: 'PTFE Bellow Expansion Joints',
    ptfeBellowDesc: 'Chemical resistant PTFE bellows for aggressive chemical environments',
    fabricBellows: 'High Temperature Fabric Bellow',
    fabricBellowDesc: 'Specialized fabric bellows designed for high-temperature applications and thermal insulation',
    whyChooseBellows: 'Why Choose Our Bellows?',
    bellowBenefitsDesc: 'Our bellows provide superior performance and reliability',
    ...
    customBellowDesc: 'Our engineering team can design custom bellows to meet your specific requirements',
    contactEngineers: 'Contact Engineers',
    
    // Fittings Page
    endFittingsTitle: 'End Fittings',
    endFittingsSubtitle: 'Comprehensive range of end fittings for secure and reliable connections',
    quickReleaseCouplings: 'Quick Release Couplings',
    quickReleaseDesc: 'Fast and secure connections for easy assembly and disassembly',
    camlockCouplings: 'Camlock Couplings',
    camlockDesc: 'Cam and groove couplings for rapid connection and disconnection',
    triCloverFittings: 'Tri Clover Fittings',
    triCloverDesc: 'Sanitary tri-clamp fittings designed for hygienic applications in food, pharmaceutical, and biotech industries',
    materialOptions: 'Material Options',
    materialDesc: 'We offer fittings in various materials to suit different applications',
    ...
    standardsDesc: 'Our fittings comply with international standards and specifications',
    ...
    customFittingsDesc: 'We can manufacture custom fittings according to your specifications and requirements',
    requestCustomQuote: 'Request Custom Quote',
    
    // About
    aboutTitle: 'About Ramal Industries',
    aboutSubtitle: 'Leading supplier of flexible hose solutions and industrial fittings',
    ourStory: 'Our Story',
    ...
    aboutText2: 'Located in Mumbai, India, we serve customers across the nation with our comprehensive range of flexible hose solutions, bellow systems, and end fittings including flanges, quick release couplings, camlock couplings, and tricolor fittings.',
    aboutText3: 'Our commitment to excellence and customer satisfaction has made us a trusted partner for industries ranging from manufacturing to water treatment, power generation, and beyond.',
    ourValues: 'Our Values',
    valuesSubtitle: 'The principles that guide our operations and define our culture',
    qualityExcellence: 'Quality Excellence',
    qualityExcellenceDesc: 'We maintain the highest standards in all our products and services',
    customerFocus: 'Customer Focus',
    customerFocusDesc: 'Our customers are at the heart of everything we do',
    innovation: 'Innovation',
    innovationDesc: 'Continuous improvement and innovation in our products and processes',
    ourAchievements: 'Our Achievements',
    achievementsSubtitle: 'Milestones that showcase our commitment to excellence',
    ourMission: 'Our Mission',
    missionText: 'To provide high-quality, innovative flexible hose solutions and industrial fittings that exceed customer expectations while maintaining the highest standards of safety, reliability, and performance.',
    ourVision: 'Our Vision',
    visionText: 'To be the leading Supplier of flexible hose solutions in India, recognized for our commitment to quality, innovation, and customer satisfaction across all industries we serve.',
    
    // Contact
    contactTitle: 'Contact Us',
    contactSubtitle: 'Get in touch with our team',
    getInTouchTitle: 'Get in Touch',
    getInTouchDesc: 'We\'re here to help you find the perfect flexible hose solutions for your industrial needs. Contact us today for expert advice and competitive pricing.',
    ...
    locationDesc: 'Located in Mumbai, we serve customers across India with our comprehensive range of industrial solutions.',
    ...
    emailNotConfigured: 'Email service is not configured. Please contact us directly at sales@ramalindustries.com',
    phone: 'Phone',
    email: 'Email',
    address: 'Address',
  ...
  ar: {
    ...
    readySubtitle: 'اتصل بنا اليوم للحصول على حلول مخصصة تلبي متطلباتك الصناعية المحددة',
    ...
    metalHoseDesc: 'خراطيم معدنية عالية الأداء مصممة لظروف درجة الحرارة والضغط القاسية',
    foodGradeHoses: 'خراطيم درجة الطعام',
    foodHoseDesc: 'خراطيم معتمدة من FDA مصممة خصيصاً لتطبيقات صناعة الأغذية والمشروبات',
    compositeHoses: 'خراطيم الصهاريج المركبة',
    compositeDesc: 'خراطيم مركبة للخدمة الشاقة للتطبيقات البحرية والصناعية للصهاريج',
    ...
    customHoseDesc: 'اتصل بخبرائنا للحصول على حلول خراطيم مخصصة مصممة خصيصاً لمتطلباتك المحددة',
    
    // Bellows Page
    bellowSolutionsTitle: 'حلول المنفاخ',
    bellowSolutionsSubtitle: 'مفاصل التمدد والمنافيخ المصممة بدقة للتطبيقات الصناعية',
    stainlessBellows: 'منافيخ التمدد من الفولاذ المقاوم للصدأ',
    stainlessBellowDesc: 'منافيخ عالية الجودة من الفولاذ المقاوم للصدأ للتمدد الحراري وامتصاص الاهتزاز',
    ...
    ptfeBellowDesc: 'منافيخ PTFE مقاومة للمواد الكيميائية للبيئات الكيميائية القاسية',
    fabricBellows: 'منفاخ القماش عالي الحرارة',
    fabricBellowDesc: 'منافيخ قماش متخصصة مصممة لتطبيقات درجات الحرارة العالية والعزل الحراري',
    ...
    customBellowDesc: 'يمكن لفريق الهندسة لدينا تصميم منافيخ مخصصة لتلبية متطلباتك المحددة',
    contactEngineers: 'اتصل بالمهندسين',
    
    // Fittings Page
    endFittingsTitle: 'تركيبات الطرف',
    endFittingsSubtitle: 'مجموعة شاملة من تركيبات الطرف للاتصالات الآمنة والموثوقة',
    ...
    triCloverDesc: 'تركيبات تراي كلامب الصحية المصممة للتطبيقات الصحية في صناعات الأغذية والأدوية والتكنولوجيا الحيوية',
    ...
    aboutText2: 'تقع في مومباي، الهند، نحن نخدم العملاء في جميع أنحاء البلاد بمجموعتنا الشاملة من حلول الخراطيم المرنة وأنظمة المنفاخ وتركيبات الطرف بما في ذلك الشفاه ووصلات التحرير السريع ووصلات كاملوك وتركيبات تراي كلوفر.',
    aboutText3: 'إن التزامنا بالتميز ورضا العملاء جعلنا شريكاً موثوقاً للصناعات التي تتراوح من التصنيع إلى معالجة المياه وتوليد الطاقة وما بعدها.',
    ourValues: 'قيمنا',
    valuesSubtitle: 'المبادئ التي توجه عملياتنا وتحدد ثقافتنا',
    qualityExcellence: 'التميز في الجودة',
    qualityExcellenceDesc: 'نحن نحافظ على أعلى المعايير في جميع منتجاتنا وخدماتنا',
    ...
    ourMission: 'مهمتنا',
    missionText: 'تقديم حلول خراطيم مرنة وتركيبات صناعية عالية الجودة ومبتكرة تتجاوز توقعات العملاء مع الحفاظ على أعلى معايير السلامة والموثوقية والأداء.',
    ourVision: 'رؤيتنا',
    visionText: 'أن نكون المورد الرائد لحلول الخراطيم المرنة في الهند، معترف بنا لالتزامنا بالجودة والابتكار ورضا العملاء عبر جميع الصناعات التي نخدمها.',
