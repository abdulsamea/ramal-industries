...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .send(
        ...
        {
          ...formData,
          to_email: "info@ramalindustries.com",
        },
        PUBLIC_KEY
      )
      .then(() => {
  ...
  const contactInfo = [
    {
      icon: (
        <Phone className="h-6 w-6" style={{ color: colors.primary.main }} />
      ),
      title: t("phone"),
    ...
    },
    {
      ...
      title: t("email"),
      details: ["info@ramalindustries.com"],
      link: "mailto:info@ramalindustries.com",
    },
    {
      icon: (
        <MapPin className="h-6 w-6" style={{ color: colors.primary.main }} />
      ),
      title: t("address"),
      details: [
    ...
    {
      icon: (
        <Clock className="h-6 w-6" style={{ color: colors.primary.main }} />
      ),
      title: t("businessHours"),
      details: [t("mondayToSaturday"), t("sundayClosed")],
    },
  ];
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">{t("locationDesc")}</p>
          </div>
            ...
            <div className="aspect-w-16 aspect-h-9 bg-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Sami Qureshi Chawl, Room No. 7, Group No.2,
                  <br />
